            ...
            try:
                ...
                async for chunk in (await get_graph(context)).astream(
                    ...
                    if stream_mode == "values":
                        ...
                        current_step = len(last_state.agents_thoughts)
                        
                        if current_step > printed_step:
                            printed_step = current_step
                            logger.info(f"========== Step {current_step}/{task.request.max_steps} ==========")
                ...
                logger.info("=" * 60)
                logger.info(f"Automation '{task_name}' completed successfully")
                ...
                logger.info("=" * 60)
                logger.info(f"Task completed in {steps_count} steps.")
                logger.info("=" * 60)
